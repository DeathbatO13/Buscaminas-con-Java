...
public class VentanaPrincipal extends javax.swing.JFrame implements ActionListener, MouseInputListener{
	...
	public VentanaPrincipal(){
	    ...
	    initComponents();
	    try {
	        this.iconoBomba = new ImageIcon(getClass().getResource("/res/mina.png"));
	        this.iconoBandera = new ImageIcon(getClass().getResource("/res/marca.png"));
	        this.iconoBombaExplota = new ImageIcon(getClass().getResource("/res/minaExplota.png"));
	        this.iconoOK = new ImageIcon(getClass().getResource("/res/ok.png"));
	        this.icono1 = new ImageIcon(getClass().getResource("/res/1.png"));
	        this.icono2 = new ImageIcon(getClass().getResource("/res/2.png"));
	        this.icono3 = new ImageIcon(getClass().getResource("/res/3.png"));
	        this.icono4 = new ImageIcon(getClass().getResource("/res/4.png"));
	        this.icono5 = new ImageIcon(getClass().getResource("/res/5.png"));
	        this.icono6 = new ImageIcon(getClass().getResource("/res/6.png"));
	        this.icono7 = new ImageIcon(getClass().getResource("/res/7.png"));
	        this.icono8 = new ImageIcon(getClass().getResource("/res/8.png"));
	    } catch (Exception e) {
	        JOptionPane.showMessageDialog(this, "Error loading resources: " + e.getMessage(), "Resource Error", JOptionPane.ERROR_MESSAGE);
	        throw new RuntimeException(e);
	    }
		this.setIconImage(iconoBombaExplota != null ? iconoBombaExplota.getImage() : null);
    ...
    public void mousePressed(MouseEvent e) {
        if (this.game == null || this.game.getEstado()!=Juego.EstadoJuego.JUGANDO){
            JOptionPane.showMessageDialog(this,"El juego ha terminado: inicia un nuevo juego");
            return;
        }
        Object src = e.getSource();
        if (!(src instanceof CeldaVisual)) {
            JOptionPane.showMessageDialog(this, "Error interno: fuente de evento no es CeldaVisual", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        CeldaVisual cv = (CeldaVisual)src;
        if (cv == null) {
            JOptionPane.showMessageDialog(this, "Error interno: celda visual nula", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        switch (e.getButton()) {
